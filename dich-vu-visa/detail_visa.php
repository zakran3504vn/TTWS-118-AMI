...
<body class="bg-white">
    ...
    <div class="bg-gradient-to-r from-primary/90 to-primary text-white py-16">
        <div class="max-w-6xl mx-auto px-4 text-center">
            ...
            <p class="text-xl opacity-90">Dịch vụ Visa  </p>
        </div>
    </div>
    <div class="bg-gray-50 py-4">
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex items-center gap-2 text-sm text-gray-600">
                ...
                <i class="ri-arrow-right-s-line"></i>
                <span class="text-primary">Tên dịch vụ</span>
            </div>
        </div>
    </div>
    <main class="py-8">
                    ...
                    <article class="bg-white rounded-lg shadow-sm overflow-hidden p-6">
                        ...
                        <div class="w-full text-2xl text-black mb-8 mx-auto">
                            <h3 class="text-2xl font-semibold mb-3">Top 10 điểm đến không thể bỏ qua khi du
                                lịch
                                Nhật Bản mùa thu</h3>
                            <p class="text-justify">Phú Quốc, hòn đảo ngọc của Việt Nam, vừa chào đón một thành viên mới
                                trong hệ thống nghỉ
