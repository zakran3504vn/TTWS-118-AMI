                            ...
                            <div class="white_box_tittle list_header">
                                <div class="box_right d-flex lms_block">
                                    ...
                                    <div class="add_button ms-2">
                                        <a href="index.php?current_page=add_news" class="btn_1">THÊM TIN TỨC</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>
                                                        <a href='index.php?current_page=edit_news&id=" . urlencode($row['news_id']) . "' class='btn btn-primary text-white btn-sm'>
