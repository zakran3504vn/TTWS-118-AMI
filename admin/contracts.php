                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="thead-light">
                                            <tr class="text-center">
                                                ...
                                                <th scope="col">Mã Số Thuế</th> <!-- Thêm cột tax_code -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>" . htmlspecialchars($row['tax_code'] ?? '') . "</td>"; // Hiển thị mã số thuế
                                                    echo "</tr>";
                                                    $stt++;
                                                }
                                            } else {
                    ...
                    button.addEventListener('click', function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'delete_contracts.php?id=<?php echo $contractId; ?>',
                                    method: 'POST',
