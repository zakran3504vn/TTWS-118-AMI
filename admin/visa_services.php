...
<head>
    ...
    <title>Quản Lý Dịch Vụ Visa</title>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="dashboard_header_title">
                                        <h3>Quản Lý Dịch Vụ Visa</h3>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="dashboard_breadcam text-end">
                                        <p><a href="../index.php">Dashboard</a> <i class="fas fa-caret-right"></i> Dịch Vụ Visa</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="white_box_tittle list_header">
                                <div class="box_right d-flex lms_block">
                                    ...
                                    <div class="add_button ms-2">
                                        <a href="add_visa.php" class="btn_1">THÊM BÀI VIẾT</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td>
                                                        <form action='visa_services.php' method='POST' class='toggle-form'>
                                                    ...
                                                    echo "<td>
                                                        <a href='edit_visa.php?id=" . urlencode($row['id']) . "' class='btn btn-primary text-white btn-sm'>
                                                            <i class='fa-solid fa-pen-to-square'></i>
                                                        </a>
                                                        <form action='visa_services.php' method='POST' class='delete-form d-inline'>
                                                ...
                                                echo "<tr><td colspan='8' class='text-center'>Không có bài viết nào.</td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table>
