    ...
    <footer class="bg-white text-black py-12">
        <div class="max-w-[1440px] mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <img src="./assets/uploads/logo-ami.png"
                        alt="AMI Travels" class="h-36 mb-4">
                    <p class="text-black text-xl mb-4">Công ty du lịch hàng đầu Việt Nam, mang đến những trải nghiệm du lịch
                        tuyệt vời nhất.</p>
                    <div class="flex gap-4">
                        <div class="w-8 h-8 flex items-center justify-center bg-primary rounded-full">
                            <i class="text-white ri-facebook-fill"></i>
                        </div>
                        <div class="w-8 h-8 flex items-center justify-center bg-secondary rounded-full">
                            <i class="text-white ri-twitter-fill"></i>
                        </div>
                        <div class="w-8 h-8 flex items-center justify-center bg-red-500 rounded-full">
                            <i class="text-white ri-youtube-fill"></i>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="space-y-3 text-black">
                        <div class="mb-6">
                            ...
                            <div class="flex items-center gap-3 mt-2">
                                ...
                                <span>amitravels589@gmail.com</span>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="mt-6">
                        <h3 class="text-xl font-semibold mb-4">Chấp Nhận Thanh Toán</h3>
                        <div class="flex items-center gap-4">
                            <i class="ri-visa-fill text-3xl text-blue-500"></i>
                            <i class="ri-mastercard-fill text-3xl text-orange-500"></i>
                            <i class="ri-bank-card-fill text-3xl text-green-500"></i>
                        </div>
                    </div>
                </div>
            </div>
