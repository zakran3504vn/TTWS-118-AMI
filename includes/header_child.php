...
<header id="mainHeader" class="bg-white text-primary shadow-sm">
        ...
        <div class="max-w-[1440px] mx-auto px-4 py-3">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden lg:flex items-center gap-8">
                    ...
                    <a href="../dich-vu-visa/index.php" class="text-black font-medium text-l hover:text-primary transition-colors">DỊCH VỤ VISA</a>
                    ...
                    <form action="../du-lich/index.php" method="GET" class="flex items-center bg-gray-100 rounded ml-4">
                        ...
                        <input type="hidden" name="duration" value="all">
                ...
                <div id="mobileMenu"
                    ...
                    <div
                        ...
                        <nav class="p-4">
                            ...
                            <a href="../gioi-thieu/index.php"
                                data-readdy="true"
                                class="block py-3 text-black font-medium text-l hover:text-primary transition-colors border-b">GIỚI THIỆU</a>
                            <div class="border-b">
                                <button
                                ...
                                <div class="hidden pl-4">
                                    <div class="border-l border-gray-200">
                                        ...
                                        <div class="hidden">
                                            <a href="../du-lich/index.php?continent=all"
                                                class="block py-3 pl-8 text-black font-medium text-l hover:text-primary transition-colors">Tất cả</a>
                            ...
                            <a href="../dich-vu-visa/index.php"
                                class="block py-3 text-black font-medium text-l hover:text-primary transition-colors border-b">DỊCH VỤ VISA</a>
                            <a href="../tin-tuc/index.php"
                                data-readdy="true"
                                class="block py-3 text-black font-medium text-l hover:text-primary transition-colors border-b">TIN TỨC</a>
                            <a href="../lien-he/index.php"
                                data-readdy="true"
                                class="block py-3 text-black font-medium text-l hover:text-primary transition-colors border-b">LIÊN HỆ</a>
                        </nav>
                    </div>
                </div>
            </div>
    ...
    <script id="mobileNav">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const headerSearchForms = document.querySelectorAll('form[action="../du-lich/index.php"]');
